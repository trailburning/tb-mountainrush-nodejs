define([
  ...
  var RegisterGameCreatePaywallView = Backbone.View.extend({
    initialize: function(options){
      this.template = _.template($('#registerGameCreatePaywallViewTemplate').text());
...
//        console.log(url);
  ...
  return RegisterGameCreatePaywallView;
});
